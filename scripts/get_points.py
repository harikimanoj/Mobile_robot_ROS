...
# Author: Harikrishnan Manoj (SOET)
# The code is used to save points generated by AMCL to a text file
...
class waypoint(object):
	...
	def get_way_point(self, msg):
		...
		print "X " , msg.pose.position.x, "m Y ", msg.pose.position.y, " m Yaw ", yaw, "degrees", 
                self.list.append([msg.pose.position.x,msg.pose.position.y,yaw])
                np.savetxt("/home/crl5/rally_ws/src/wall_follower/resources/waypoints.txt",np.array(self.list))
